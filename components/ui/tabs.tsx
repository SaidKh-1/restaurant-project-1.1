...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        "bg-muted text-muted-foreground inline-flex h-9 w-full items-center justify-start gap-1 overflow-x-auto rounded-lg p-1 md:w-fit",
        className,
      )}
      {...props}
    />
